...
public class TodoList {
    ...
    /**
     * 전체 EditText를 Acty_AddNewSquad에서 line 1줄로 제한하고, focus 잃으면 keyboard 없어지는 기능 적용되도록 -> 폰에서 확인해야함
     *
     ...
     *
     * 화면 RecyclerView 스크롤 보이도록?? 어떻게 하는지 확인해야함
     *
     *
     *
     */
